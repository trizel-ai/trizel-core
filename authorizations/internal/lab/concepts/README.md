...
1. **Concept Name:** Clear identifier
2. **Definition:** Precise conceptual definition
3. **Source Traceability:** ORCID → Publication → Section/Page
...
- **Hypothesis-Driven:** Concepts explored, not assumed as truth
- **Pre-Paradigmatic:** Language avoids dogmatic assertions
- **ORCID-Traced:** All concepts traceable to ORCID sources
